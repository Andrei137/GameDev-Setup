...
bool initGame()
{
	...
	platform::readEntireFile(RESOURCES_PATH "game_data.data", &gameData, sizeof(GameData));
...
void closeGame()
{
	...
	//saved the data.
	platform::writeEntireFile(RESOURCES_PATH "game_data.data", &gameData, sizeof(GameData));
